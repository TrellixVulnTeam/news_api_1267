    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to Yozakura Portfolio site!
        </h2>
        ...
        <ul>
          <li><NuxtLink to="/about">aboutページへ</NuxtLink></li>
          <li><NuxtLink to="/todos">Todosページへ</NuxtLink></li>
          <li><NuxtLink to="/members">Membersページへ</NuxtLink></li>
        </ul>
      </div>
